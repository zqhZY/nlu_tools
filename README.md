# nlu_tools
NLU tools for sentence semantics matching and classification in tensorflow with simple software architecture(base on [Tensorflow Project Template](https://github.com/MrGemy95/Tensorflow-Project-Template)).
