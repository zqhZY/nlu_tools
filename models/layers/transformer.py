...
from models.layers import attention_layer
from models.layers import ffn_layer
...
class TransformerEncoder(object):
  ...
  def __call__(self, inputs, embedding, targets=None):
    ...
    with tf.variable_scope("Transformer", initializer=initializer):
      ...
      encoder_outputs = self.encode(inputs, embedding, attention_bias)
      return encoder_outputs

  def encode(self, inputs, embedded_inputs, attention_bias):
